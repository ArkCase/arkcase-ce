...
INSERT INTO QRTZ5_LOCKS values('TRIGGER_ACCESS') ON CONFLICT (LOCK_NAME) DO UPDATE SET LOCK_NAME = EXCLUDED.LOCK_NAME;
INSERT INTO QRTZ5_LOCKS values('JOB_ACCESS') ON CONFLICT (LOCK_NAME) DO UPDATE SET LOCK_NAME = EXCLUDED.LOCK_NAME;
INSERT INTO QRTZ5_LOCKS values('CALENDAR_ACCESS') ON CONFLICT (LOCK_NAME) DO UPDATE SET LOCK_NAME = EXCLUDED.LOCK_NAME;
INSERT INTO QRTZ5_LOCKS values('STATE_ACCESS') ON CONFLICT (LOCK_NAME) DO UPDATE SET LOCK_NAME = EXCLUDED.LOCK_NAME;
INSERT INTO QRTZ5_LOCKS values('MISFIRE_ACCESS') ON CONFLICT (LOCK_NAME) DO UPDATE SET LOCK_NAME = EXCLUDED.LOCK_NAME;
commit;
